---
title: "Onboarding: creating an org in terminal or browser"
sidebarTitle: "Onboarding: starting fresh"
description: "Retasc setup takes you from creating an organization to connecting an agent and inviting your team. You can use the terminal or web Dash."
"og:image": "https://docs.retasc.com/images/og/onboarding-owner.png?v=4a8e3803"
"og:image:alt": "retasc docs: Onboarding: creating an org in terminal or browser"
"twitter:image": "https://docs.retasc.com/images/og/onboarding-owner.png?v=4a8e3803"
"twitter:image:alt": "retasc docs: Onboarding: creating an org in terminal or browser"
---
...
<Warning>
  **Paying is browser-only.** `retasc billing` shows your balance and what you've
  been charged, but there's no checkout in the CLI. Not a setup blocker,
...
<Steps>
  <Step title="Sign in">
    ...
    <img src="/images/ui/signin-light.png" alt="The Retasc Dash sign-in card: continue with GitHub, Google or a passkey" className="rt-shot rt-shot-light rt-shot-wide" />
<img src="/images/ui/signin-light-phone.png" alt="The Retasc Dash sign-in card: continue with GitHub, Google or a passkey" className="rt-shot rt-shot-light rt-shot-narrow" />
    <img src="/images/ui/signin-dark.png" alt="The Retasc Dash sign-in card: continue with GitHub, Google or a passkey" className="rt-shot rt-shot-dark rt-shot-wide" />
<img src="/images/ui/signin-dark-phone.png" alt="The Retasc Dash sign-in card: continue with GitHub, Google or a passkey" className="rt-shot rt-shot-dark rt-shot-narrow" />
  </Step>
  <Step title="Create the org">
    Name your organization. You're its owner.

    <img src="/images/ui/new-org-light.png" alt="Creating an org in the Dash: a name and an optional slug" className="rt-shot rt-shot-light rt-shot-wide" />
<img src="/images/ui/new-org-light-phone.png" alt="Creating an org in the Dash: a name and an optional slug" className="rt-shot rt-shot-light rt-shot-narrow" />
    <img src="/images/ui/new-org-dark.png" alt="Creating an org in the Dash: a name and an optional slug" className="rt-shot rt-shot-dark rt-shot-wide" />
<img src="/images/ui/new-org-dark-phone.png" alt="Creating an org in the Dash: a name and an optional slug" className="rt-shot rt-shot-dark rt-shot-narrow" />
  </Step>
  <Step title="Pick your tracker, or start fresh">
    Bring Linear, Jira, ClickUp, Asana or Shortcut across, or create an empty
    project.

    <img src="/images/ui/first-project-light.png" alt="Naming the first project in the Dash, with its issue prefix" className="rt-shot rt-shot-light rt-shot-wide" />
<img src="/images/ui/first-project-light-phone.png" alt="Naming the first project in the Dash, with its issue prefix" className="rt-shot rt-shot-light rt-shot-narrow" />
    <img src="/images/ui/first-project-dark.png" alt="Naming the first project in the Dash, with its issue prefix" className="rt-shot rt-shot-dark rt-shot-wide" />
<img src="/images/ui/first-project-dark-phone.png" alt="Naming the first project in the Dash, with its issue prefix" className="rt-shot rt-shot-dark rt-shot-narrow" />
  </Step>
  ...
  <Step title="Claim your imported identity">
    ...
    <img src="/images/ui/import-history-light.png" alt="The Dash asking which imported name is you, with a That's me button" className="rt-shot rt-shot-light rt-shot-wide" />
<img src="/images/ui/import-history-light-phone.png" alt="The Dash asking which imported name is you, with a That's me button" className="rt-shot rt-shot-light rt-shot-narrow" />
    <img src="/images/ui/import-history-dark.png" alt="The Dash asking which imported name is you, with a That's me button" className="rt-shot rt-shot-dark rt-shot-wide" />
<img src="/images/ui/import-history-dark-phone.png" alt="The Dash asking which imported name is you, with a That's me button" className="rt-shot rt-shot-dark rt-shot-narrow" />
  </Step>
...
<img src="/images/ui/connect-agent-light.png" alt="The Dash's last onboarding step: the line to paste to your agent, and a waiting indicator" className="rt-shot rt-shot-light rt-shot-wide" />
<img src="/images/ui/connect-agent-light-phone.png" alt="The Dash's last onboarding step: the line to paste to your agent, and a waiting indicator" className="rt-shot rt-shot-light rt-shot-narrow" />
<img src="/images/ui/connect-agent-dark.png" alt="The Dash's last onboarding step: the line to paste to your agent, and a waiting indicator" className="rt-shot rt-shot-dark rt-shot-wide" />
<img src="/images/ui/connect-agent-dark-phone.png" alt="The Dash's last onboarding step: the line to paste to your agent, and a waiting indicator" className="rt-shot rt-shot-dark rt-shot-narrow" />
