...
"og:image": "https://docs.retasc.com/images/og/onboarding-owner.png?v=2585a18b"
"og:image:alt": "retasc docs: Onboarding: starting fresh"
"twitter:image": "https://docs.retasc.com/images/og/onboarding-owner.png?v=2585a18b"
"twitter:image:alt": "retasc docs: Onboarding: starting fresh"
---
...
<Steps>
  ...
  <img className="rt-shot-dark" src="/images/ui/signin-dark.png" alt="The Retasc Dash sign-in card: continue with GitHub, Google or a passkey" />
  <img className="rt-shot-light" src="/images/ui/signin-light.png" alt="The Retasc Dash sign-in card: continue with GitHub, Google or a passkey" />
  <img className="rt-shot-dark rt-shot-phone" src="/images/ui/signin-dark-phone.png" alt="The Retasc Dash sign-in card: continue with GitHub, Google or a passkey" />
  <img className="rt-shot-light rt-shot-phone" src="/images/ui/signin-light-phone.png" alt="The Retasc Dash sign-in card: continue with GitHub, Google or a passkey" />
</div>
  </Step>
  <Step title="Create the org">
    ...
    <div className="rt-shots">
  <img className="rt-shot-dark" src="/images/ui/new-org-dark.png" alt="Creating an org in the Dash: a name and an optional slug" />
  <img className="rt-shot-light" src="/images/ui/new-org-light.png" alt="Creating an org in the Dash: a name and an optional slug" />
  <img className="rt-shot-dark rt-shot-phone" src="/images/ui/new-org-dark-phone.png" alt="Creating an org in the Dash: a name and an optional slug" />
  <img className="rt-shot-light rt-shot-phone" src="/images/ui/new-org-light-phone.png" alt="Creating an org in the Dash: a name and an optional slug" />
</div>
  </Step>
  <Step title="Pick your tracker, or start fresh">
    ...
    <div className="rt-shots">
  <img className="rt-shot-dark" src="/images/ui/first-project-dark.png" alt="Naming the first project in the Dash, with its issue prefix" />
  <img className="rt-shot-light" src="/images/ui/first-project-light.png" alt="Naming the first project in the Dash, with its issue prefix" />
  <img className="rt-shot-dark rt-shot-phone" src="/images/ui/first-project-dark-phone.png" alt="Naming the first project in the Dash, with its issue prefix" />
  <img className="rt-shot-light rt-shot-phone" src="/images/ui/first-project-light-phone.png" alt="Naming the first project in the Dash, with its issue prefix" />
</div>
  </Step>
