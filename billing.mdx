...
When you authorize billing you set a **cap** (the lifetime permit allowance Retasc can
pull against) and a **monthly limit**. Both are your settings — visible in the Dashboard
**Billing** card, and editable any time from the hosted manage page (opened with the
...
A new org is seeded a **signup credit**, a usage-bound voucher (default $10).
