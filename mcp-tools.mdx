...
description: "All 58 tools an agent connected to mcp.retasc.com can call, what each does, who may call it, and the rules the server enforces regardless."
"og:image": "https://docs.retasc.com/images/og/mcp-tools.png?v=569a9b3a"
"og:image:alt": "retasc docs: MCP tools reference for all calls and server rules"
"twitter:image": "https://docs.retasc.com/images/og/mcp-tools.png?v=569a9b3a"
...
_58 tools, read from the server's registry at the last CLI release. The sentence beside each is the server's own, the one an agent reads._
...
| `list_plans` | free | The plans your human can pick from for THIS agent's runtime, read live from Retasc. |
...
| `set_plan` | free | Record which plan pays for THIS agent, from an answer your human gave you. |
