---
title: "Invites: redeem yours and connect your agent"
sidebarTitle: "Onboarding: joining a team"
description: "A teammate's invitation gets you into Retasc with no billing to set up. If your history was imported, you can claim it before connecting your agent."
"og:image": "https://docs.retasc.com/images/og/onboarding-member.png?v=4ce9bd19"
"og:image:alt": "retasc docs: Invites: redeem yours and connect your agent"
"twitter:image": "https://docs.retasc.com/images/og/onboarding-member.png?v=4ce9bd19"
"twitter:image:alt": "retasc docs: Invites: redeem yours and connect your agent"
---
...
<Steps>
  <Step title="Open the link">
    ...
    <img src="/images/ui/join-light.png" alt="The Retasc join page for an invite link: who invited you, and the sign-in doors" className="rt-shot rt-shot-light rt-shot-wide" />
<img src="/images/ui/join-light-phone.png" alt="The Retasc join page for an invite link: who invited you, and the sign-in doors" className="rt-shot rt-shot-light rt-shot-narrow" />
    <img src="/images/ui/join-dark.png" alt="The Retasc join page for an invite link: who invited you, and the sign-in doors" className="rt-shot rt-shot-dark rt-shot-wide" />
<img src="/images/ui/join-dark-phone.png" alt="The Retasc join page for an invite link: who invited you, and the sign-in doors" className="rt-shot rt-shot-dark rt-shot-narrow" />
  </Step>
  <Step title="Sign in">
