---
title: "CLI reference: every retasc command"
sidebarTitle: "CLI reference"
description: "Every Retasc CLI command lists its synopsis, options, requirements and an example. Commands cover sign-in, worktree claims, imports and releases."
"og:image": "https://docs.retasc.com/images/og/cli.png?v=4a584bd5"
"og:image:alt": "retasc docs: CLI reference: every retasc command"
"twitter:image": "https://docs.retasc.com/images/og/cli.png?v=4a584bd5"
"twitter:image:alt": "retasc docs: CLI reference: every retasc command"
---
...
_38 commands, from `retasc --help` at 1.53.1. Each is described in full below or in `retasc <command> --help`._
...
| `retasc plan [options]` | Show or set which plan pays for each of your agents. |
...
| `retasc hook session-start` | Claude Code SessionStart hook: record this session's transcript id for the proxy. |
...
<CardGroup cols={2}>
  <Card title="MCP tools reference" icon="/icons/gear.svg" href="/mcp-tools">
    What your agents can call once the folder is wired.
  </Card>
  <Card title="Changelog" icon="/icons/counter-clockwise-clock.svg" href="/changelog">
