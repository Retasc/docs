...
"og:image": "https://docs.retasc.com/images/og/sync.png?v=b623a1a1"
"og:image:alt": "retasc docs: GitHub & GitLab sync"
"twitter:image": "https://docs.retasc.com/images/og/sync.png?v=b623a1a1"
"twitter:image:alt": "retasc docs: GitHub & GitLab sync"
---
...
<div className="rt-shots">
  <img className="rt-shot-dark" src="/images/ui/connector-github-dark.png" alt="The GitHub connector in the Dash: the repo field, the webhook URL and its signing secret" />
  <img className="rt-shot-light" src="/images/ui/connector-github-light.png" alt="The GitHub connector in the Dash: the repo field, the webhook URL and its signing secret" />
  <img className="rt-shot-dark rt-shot-phone" src="/images/ui/connector-github-dark-phone.png" alt="The GitHub connector in the Dash: the repo field, the webhook URL and its signing secret" />
  <img className="rt-shot-light rt-shot-phone" src="/images/ui/connector-github-light-phone.png" alt="The GitHub connector in the Dash: the repo field, the webhook URL and its signing secret" />
</div>
