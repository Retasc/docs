---
title: "GitHub and GitLab sync: external PRs enter review"
sidebarTitle: "GitHub & GitLab sync"
...
"og:image": "https://docs.retasc.com/images/og/sync.png?v=91cc8f9b"
"og:image:alt": "retasc docs: GitHub and GitLab sync: external PRs enter review"
"twitter:image": "https://docs.retasc.com/images/og/sync.png?v=91cc8f9b"
"twitter:image:alt": "retasc docs: GitHub and GitLab sync: external PRs enter review"
---
...
<img src="/images/ui/connector-github-light.png" alt="The GitHub connector in the Dash: the repo field, the webhook URL and its signing secret" className="rt-shot rt-shot-light rt-shot-wide" />
<img src="/images/ui/connector-github-light-phone.png" alt="The GitHub connector in the Dash: the repo field, the webhook URL and its signing secret" className="rt-shot rt-shot-light rt-shot-narrow" />
<img src="/images/ui/connector-github-dark.png" alt="The GitHub connector in the Dash: the repo field, the webhook URL and its signing secret" className="rt-shot rt-shot-dark rt-shot-wide" />
<img src="/images/ui/connector-github-dark-phone.png" alt="The GitHub connector in the Dash: the repo field, the webhook URL and its signing secret" className="rt-shot rt-shot-dark rt-shot-narrow" />
